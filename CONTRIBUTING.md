Contributing to Flowgre
=======================

Summary
-------
This document covers how to contribute to the Flowgre project. Flowgre uses github PRs to manage code contributions. 
These instructions assume you have a GitHub.com account, so if you don't have one you will have to create one. Your proposed code changes will be published to your own fork of the Flowgre project and you will submit a Pull Request for your changes to be added.
...
In your browser, navigate to: [https://github.com/dmabry/flowgre](https://github.com/dmabry/flowgre)

Fork the repository by clicking on the 'Fork' button on the top right hand side.  The fork will happen and you will be taken to your own fork of the repository.  Copy the Git repository URL by clicking on the clipboard next to the URL on the right hand side of the page under '**HTTPS** clone URL'.  You will paste this URL when doing the following `git clone` command.

On your computer, follow these steps to setup a local repository for working on Flowgre:

``` bash
$ git clone https://github.com/YOUR_ACCOUNT/flowgre.git
$ cd flowgre
$ git remote add upstream https://github.com/dmabry/flowgre.git
$ git checkout main
$ git fetch upstream
...
Please include detailed information about the bug/feature, what all tests are executed, how the reviewer can test this feature etc.
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/flowgre](https://github.com/YOUR_ACCOUNT/flowgre)
